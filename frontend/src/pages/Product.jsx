...
export default function Product() {
  ...
  const [shopeeUrl, setShopeeUrl]     = useState(null)
  ...
  useEffect(() => {
    ...
    fetchHero()
      .then(d => {
        ...
        if (d?.shopee_store_url) setShopeeUrl(d.shopee_store_url)
        if (d?.tokopedia_url)    setTokopediaUrl(d.tokopedia_url)
        if (d?.tiktok_url)       setTiktokUrl(d.tiktok_url)
      })
      .catch(() => {})
  }, [slug])
  ...
  const handleShopee = () => {
    ...
    window.open(product.shopee_url || shopeeUrl, '_blank')
  }

  const handleTiktok = () => {
    if (product?.id) trackClick(product.id, 'tiktok')
    window.open(product.tiktok_url || tiktokUrl, '_blank')
  }
          ...
          <div className="product-info">
            ...
            <div className="product-info__ctas">
              ...
              <div className="product-info__marketplaces">
                <button className="btn-outline" onClick={handleShopee}>
                ...
                <button className="btn-outline" onClick={handleTokopedia}>
                  <svg width="16" height="16" viewBox="0 0 192 192" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <button className="btn-outline" onClick={handleTiktok}>
